...
local themes = {
	preset = {
		["outline"] = rgb(36, 32, 38), --
		["inline"] = rgb(75, 55, 75), --
		["accent"] = rgb(180, 100, 255), --
		["contrast"] = rgb(41, 35, 47),
		["text"] = rgb(170, 170, 170),
		["unselected_text"] = rgb(90, 90, 90),
		["text_outline"] = rgb(0, 0, 0),
		["glow"] = rgb(185, 100, 255),
	},
...
function library:window(properties)
	...
	local animated_text = library:animation(cfg.name .. " | fallen survival private ")
